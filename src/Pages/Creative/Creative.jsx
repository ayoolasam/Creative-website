...
const Creative = () => {
  ...
  return (
    <div class="Creative" data-aos="fade-up">
      ...
      <Hero />
      <div class="Writes">
        <h1 style={{ marginLeft: "40px", width: "800px" }}>
          Where Every <span>Portfolio</span>
        </h1>
        <h1 style={{ width: "800px", display: "flex" }}>
          unfolds A Unique Tale Of
        </h1>
        <h1 style={{ marginLeft: "20px" }}>Creativity</h1>
      </div>
      <Pictures />
      <div class="feint">
        <p style={{ marginLeft: "30px" }}>
          Discover The Stories within each portfolio, where creativity knows no
          bounds
        </p>
        <p>
      ...
      <div>
        <div class="Disco">
          <h1 style={{ marginRight: "100px", width: "650px" }}>
            Discover What
          </h1>
          <h1>
